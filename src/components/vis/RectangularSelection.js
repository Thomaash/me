...
export default class {
  ...
  get _rectCanvas () {
    let { x: startX, y: startY } = this._network.DOMtoCanvas({ x: this._rectDOM.startX, y: this._rectDOM.startY })
    let { x: endX, y: endY } = this._network.DOMtoCanvas({ x: this._rectDOM.endX, y: this._rectDOM.endY })
