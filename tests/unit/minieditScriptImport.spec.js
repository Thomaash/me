...
describe('Import Miniedit script', () => {
  ;[{
    ...
    items: [
      { type: 'controller', hostname: 'c0', protocol: 'tcp', port: 6633, controllerType: 'Controller' },
      { type: 'controller', hostname: 'c1', protocol: 'tcp', port: 6643, controllerType: 'RemoteController', ip: '127.0.0.1' },
      { type: 'controller', hostname: 'c2', protocol: 'tcp', port: 6653, controllerType: 'OVSController' },
      ...
      { type: 'host', hostname: 'h6', startScript: 'vconfig add h6-eth0 600\nifconfig h6-eth0.600 172.16.0.6\nvconfig add h6-eth0 700\nifconfig h6-eth0.700 172.17.0.6' },
      { type: 'host', hostname: 'r4', startScript: 'sysctl -w net.ipv4.ip_forward=1' },
      ...
      { type: 'switch', hostname: 's1', switchType: 'OVSSwitch', dpctlPort: 12345, dpid: 'acdc', startScript: 'ip l', stopScript: 'ip a' },
      { type: 'switch', hostname: 's2', switchType: 'OVSSwitch', startScript: 'ifconfig s2 127.0.0.6' },
